  ...
  <ion-page>
        ...
        <ion-content>
            ...
            <div class="regforms">
                ...
                <ion-input type="password" v-model="user.password" placeholder="Password"></ion-input>
                <ion-input type="password" v-model="user.cnfpassword" placeholder="Confirm Password"></ion-input>
...
export default ({
  ...
  methods:{
    ...
    register(){
        ...
        axiosReq({
            method: 'post',
            url: 'https://localhost/kim/ciapi/api/users/register',
            data: this.user
        }).catch(res=>{
