    ...
    <ion-page>
        ...
        <ion-content>
            ...
            <div class="form">
                ...
                <ion-button expand="block" size="large" @click="$router.push('/customer/choose-service')">Next Step</ion-button>
            </div>
...
ion-content{--background:#222;border-radius:20px 20px 0 0;overflow:hidden;--color:#fff}
